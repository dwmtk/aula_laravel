                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/parkinginsert') }}" class="h-adr">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="parking_postcode" type="text" class="form-control @error('parking_postcode') is-invalid @enderror p-postal-code" name="parking_postcode" value="{{ old('parking_postcode') }}" placeholder="例）4600031" required autocomplete="parking_postcode" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="parking_prefecture" type="text" class="form-control @error('parking_prefecture') is-invalid @enderror p-region" name="parking_prefecture" value="{{ old('parking_prefecture') }}" placeholder="例）愛知県" required autocomplete="name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="parking_city" type="parking_city" class="form-control @error('parking_city') is-invalid @enderror p-locality p-street-address p-extended-address" name="parking_city" value="{{ old('parking_city') }}" placeholder="例）名古屋市中区本丸" required autocomplete="parking_city">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="parking_address" type="Phone" class="form-control @error('parking_address') is-invalid @enderror" name="parking_address" value="{{ old('parking_address') }}" placeholder="例）１−１" required autocomplete="parking_address">
